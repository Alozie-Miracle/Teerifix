    ...
    <div className='py-10 bg-gray-100 overflow-x-hidden'>
        <div className='max-w-[90%] xl:max-w-[80%] mx-auto p-5'>
            ...
            <div className='flex gap-5 mt-16 overflow-x-scroll scrollbar-hide'>
                <div className='w-[250px] xl:w-[40%] h-[250px] bg-white shadow-2xl rounded-md flex flex-shrink-0 flex-col items-center justify-center hover:scale-105 transition-all ease-in-out duration-300 cursor-pointer'>
